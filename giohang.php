                  ...
                  <div class="cart-items"> <!--edit -->
                    <div class="cart-row">
                      <div class="cart-item cart-column">
                        ...
                        <span class="cart-item-title">GOLDEN</span>
                      </div>
                      <span class="cart-price cart-column">12000000đ</span>
                    ...
                    <div class="cart-row">
                      ...
                      <span class="cart-price cart-column">1800000đ</span>
                      <div class="cart-quantity cart-column">
                        <input class="cart-quantity-input" type="number" value="1">
                        <button class="btn btn-danger" type="button">Xóa</button>
                      </div>
                    ...
                    <div class="cart-total">
                      ...
                      <span class="cart-total-price">13800000 VNĐ</span>
                    </div>
                  </div>
                </div>
            </div>
