      ...
      <div class="footertitle">
        ...
        <div>
          ...
          <ul>
            ...
            <li><a href="./tragop.php">MUA TRẢ GÓP 0%</a></li>
          </ul>
        </div>
        <div>
          <h4>THÔNG TIN LIÊN HỆ</h4>
          <ul>
            <li><a><i class="fas fa-map-marker-alt"></i> KP6, LINH TRUNG, THỦ ĐỨC, TP HCM</a></li>
            <li><a><i class="far fa-phone-alt"></i> Tư vấn mua: <span style="color: #e26e02;"><a
