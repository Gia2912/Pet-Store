  ...
  <main>
    <div class="trangchu">
      <ul>
        ...
        <li><a href="./husky.html">
        <li>Husky</a></li>
        <li class="BD1"></li>
      </ul>
    </div>
    <div class="dong1">
      <p>Husky Wooly đen trắng mắt xanh</p>
    </div>
    <div class="cat1">
      <div class="image-cat1">
        <img style="margin-left:70px" width="450" height="350" src="./img/dog/husky2.jfif" alt="Alaska nâu đỏ">
      </div>
      <div class="sale">
        <ul>
          <li class="unline-decoration-text">13.000.000đ</li>
          <li class="normal">11.000.000đ</li>
        </ul>
      </div>
      <div class="word1">
        <p>Giống Chó: Husky</p><br>
        <p>Màu sắc: Nâu đỏ</p><br>
        <p>Giới tính: Đực</p><br>
        <p>Độ tuổi: 2 tháng tuổi</p><br>
        <p>Màu lông: Đen trắng</p><br>
        <p>Cân nặng: 4,5kg</p><br>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="cart-items">
              <div class="cart-row" style="display: flex; flex-wrap: nowrap;">
                <div class="cart-item cart-column" style="width: 30%;">
                  <img class="cart-item-image" src="./img/dog/husky2.jfif" width="100" height="100">
                  <span class="cart-item-title">Husky Wooly đen trắng mắt xanh</span>
                </div>
                <span class="cart-price cart-column" style="width: 20%; text-align: center; margin: 20px auto;">11000000đ</span>
            ...
            <div class="cart-total" style="margin-top: 5px;">
              ...
              <span class="cart-total-price">11000000VNĐ</span>
            </div>
      ...
      <div class="word3">
        <p>Husky Siberian (hay Husky Sibir) là giống chó tuyết kéo xe được ưa chuộng tại các vùng đất lạnh giá khắc nghiệt. Husky giờ đây là những người bạn thân thiết với tất cả mọi người. Theo thống kê mới đây, Husky thuộc Top vật nuôi được mọi người yêu thích nhất trên Thế Giới.</p>
      </div>
      <div class="Cat2">
        <div class="image-cat2">
          <img width="1000" height="500" src="./img/dog/husky (1).png" alt="Husky">
        </div>
      </div>
      <div class="word4">
        <h3>Husky được Hiệp hội chó giống Hoa Kỳ (AKC) công nhận vào năm 1930 với tên gọi “Husky Bắc Cực”. Cho đến tận năm 1991, giống cảnh khuyển này được đổi tên chính thức thành Husky Sibir với ý nghĩa giống chó này có xuất xứ từ vùng Siberia – nước Nga.</h3>
        <h4>Chiều cao, cân nặng của Husky</h4>
        <p>Do ngoại hình của Husky và Alaska tương đối giống nhau nên sẽ gặp khá nhiều khó khăn trong việc phân biệt. Nhưng nếu bạn tìm hiểu thì sẽ nhận ra, Husky có thân hình nhỏ hơn nhiều so với Alaska. Chiều cao trung bình chỉ rơi vào khoảng 53-55cm và cân nặng từ 20-25kg (thường những chú Husky đực sẽ có thân hình nhỉnh hơn một chút so với những con cái).</p>
        <h4>Bộ lông của chó Husky</h4>
        <p>Husky có nguồn gốc từ xứ lạnh, do đó lông của chúng khá dài và dày. Màu lông Husky phổ biến nhất là màu trắng – đen, sau đó đến xám – trắng, nâu đỏ – trắng, hồng phấn – trắng. Hiếm gặp nhất là những bé cún sở hữu màu trắng tuyền và “Agouti”. Đặc biệt, phần mặt và 4 chân của Husky luôn có lông màu trắng. Đây cũng là đặc điểm quan trọng để bạn nhận biết giữa Husky thuần chủng và lai tạp.</p>
      </div>
      <footer>
