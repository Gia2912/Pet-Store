  ...
  <main>
    <div class="trangchu">
      <ul>
        ...
        <li><a href="./thucan.html">
        <li>Vật dụng ăn uống /</a></li>

        <li><a href="./balo_vaimem.html">
        <li>Bát ăn đôi tròn Round Dog</a></li>
        <li class="BD1"></li>
      </ul>
    </div>
    <div class="dong1">
      <p>Bát ăn đôi tròn Round Dog</p>
    </div>
    <div class="cat1">
      <div class="image-cat1">
        <img style="margin-left:70px" width="450" height="350" src="./img/phukien/bat-an.jpg" alt="Bát ăn đôi tròn">
      </div>
      <div class="sale">
        <ul>
          <li class="normal">45.000đ</li>
        </ul>
      </div>
      <div class="word1">
        <p>Bát ăn đôi tròn cho chó mèo được làm từ chất liệu nhựa cao cấp không gây hại, 
            không làm ảnh hưởng đến chất lượng thức ăn, màu sắc bất mắt giúp thú cưng ăn ngon mệng hơn.</p><br>
        <p>+ Sản phẩm Bát ăn đôi tròn cho chó mèo xứng đáng là sự lựa chọn lý tưởng của bạn dành cho thú cưng.</p><br>
        <p>+ Bề mặt trơn láng, dễ dàng chùi rửa sạch sẽ sau khi sử dụng.</p><br>
        <p>+ Được thiết kế dựa trên tiêu chuẩn chất lượng của Châu Âu.</p><br>
        <p>+ Có nhiều màu sắc khác nhau Bát ăn đôi tròn cho chó mèo bền, đẹp cho chó mèo từ lớn đến bé.</p><br>
        <p>+ Bát được thiết kế giúp chó mèo ăn chống rơi vãi ra ngoài.</p><br>
        <p></p><br>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="cart-items">
              <div class="cart-row" style="display: flex; flex-wrap: nowrap;">
                <div class="cart-item cart-column" style="width: 30%;">
                  <img class="cart-item-image" src="./img/phukien/bat-an.jpg" width="100" height="100">
                  <span class="cart-item-title">Bát ăn đôi tròn Round Dog</span>
                </div>
                <span class="cart-price cart-column" style="width: 20%; text-align: center; margin: 20px auto;">45000đ</span>
            ...
            <div class="cart-total" style="margin-top: 5px;">
              ...
              <span class="cart-total-price">45000VNĐ</span>
            </div>
