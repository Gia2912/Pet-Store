  ...
  <main>
    ...
    <div class="cat1">
      <div class="image-cat1">
        <img style="margin-left:70px" width="450" height="350" src="./img/phukien/sua-tam-sos-1.jpg" alt="Sữa tắm SOS">
      </div>
      <div class="sale">
        <ul>
          <li class="normal">200.000đ</li>
        </ul>
      </div>
      <div class="word1">
        <p>SOS màu nâu đỏ: Dòng sữa tắm dành riêng cho cho những bé chó mèo có bộ lông nâu đỏ, đen.</p><br>
        <p>SOS màu xanh dương: Dòng sữa tắm dành riêng cho các bé chó mèo sở hữu bộ lông trắng.</p><br>
        <p>SOS màu đen: Dòng sữa tắm chuyên dùng để phục hồi da tổn thương và đuổi ve rận cho chó mèo</p><br>
        <p></p><br>
        <p></p><br>
        <p></p><br>
        <p></p><br>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="cart-items">
              <div class="cart-row" style="display: flex; flex-wrap: nowrap;">
                <div class="cart-item cart-column" style="width: 30%;">
                  <img class="cart-item-image" src="./img/phukien/sua-tam-sos-1.jpg" width="100" height="100">
                  <span class="cart-item-title">Sữa tắm SOS</span>
                </div>
                <span class="cart-price cart-column" style="width: 20%; text-align: center; margin: 20px auto;">200000đ</span>
            ...
            <div class="cart-total" style="margin-top: 5px;">
              ...
              <span class="cart-total-price">200000VNĐ</span>
            </div>
