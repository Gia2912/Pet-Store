  ...
  <main>
    <div class="trangchu">
      <ul>
        ...
        <li><a href="./dochoi.html">
        <li>Đồ chơi & Dụng cụ huấn luyện /</a></li>

        <li><a href="./balo_vaimem.html">
        <li>Bóng Thừng 2 Đầu KITTEN</a></li>
        <li class="BD1"></li>
      </ul>
    </div>
    <div class="dong1">
      <p>Bóng Thừng 2 Đầu KITTEN</p>
    </div>
    <div class="cat1">
      <div class="image-cat1">
        <img style="margin-left:70px" width="450" height="350" src="./img/phukien/banh-tron-2-dau-2.jpg" alt="Bóng Thừng">
      </div>
      <div class="sale">
        <ul>
          <li class="normal">80.000đ</li>
        </ul>
      </div>
      <div class="word1">
        <p>Đồ Chơi Cho Chó Mèo Dạng Bóng Thừng 2 Đầu KITTEN với màu sắc đa dạng, ngẫu nhiên.</p><br>
        <p>Sản phẩm được làm bởi chất liệu thừng cotton chất lượng cao, dệt đan chắc chắn, bền bỉ đáp ứng nhu cầu gặm cắn của chó mèo.</p><br>
        <p>Sản phẩm này là lựa chọn tuyệt vời kích thích bản năng nhai – gặm tự nhiên của thú cưng giúp làm sạch răng và nướu.</p><br>
        <p></p><br>
        <p></p><br>
        <p></p><br>
        <p></p><br>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="cart-items">
              <div class="cart-row" style="display: flex; flex-wrap: nowrap;">
                <div class="cart-item cart-column" style="width: 30%;">
                  <img class="cart-item-image" src="./img/phukien/banh-tron-2-dau-2.jpg" width="100" height="100">
                  <span class="cart-item-title">Bóng Thừng 2 Đầu KITTEN</span>
                </div>
                <span class="cart-price cart-column" style="width: 20%; text-align: center; margin: 20px auto;">80000đ</span>
            ...
            <div class="cart-total" style="margin-top: 5px;">
              ...
              <span class="cart-total-price">80000VNĐ</span>
            </div>
