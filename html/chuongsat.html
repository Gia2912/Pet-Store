  ...
  <main>
    <div class="trangchu">
      <ul>
        ...
        <li><a href="./Chuong&nem.html">
        <li>Chuồng & Nệm /</a></li>

        <li><a href="./balo_vaimem.html">
        <li>Chuồng sắt cho chó mèo (size vừa)</a></li>
        <li class="BD1"></li>
      </ul>
    </div>
    <div class="dong1">
      <p>Chuồng sắt cho chó mèo (size vừa)</p>
    </div>
    <div class="cat1">
      <div class="image-cat1">
        <img style="margin-left:70px" width="450" height="350" src="./img/phukien/chuong-gap-1.jpg" alt="Chuồng sắt cho chó mèo (size vừa)">
      </div>
      <div class="sale">
        <ul>
          <li class="normal">815.000đ</li>
        </ul>
      </div>
      <div class="word1">
        <p>Chuồng sắt cho chó mèo chống gỉ gấp gọn được thiết kế với chiều cao và dài rộng hợp lý tùy theo kích thước của mỗi thú cưng.</p><br>
        <p>Đi kèm theo sản phẩm là khay nhựa lót sàn thoáng giúp việc đi vệ sinh của thú cưng sạch sẽ hơn cùng khay đựng bát ăn uống tiện lợi.</p><br>
        <p>Những bản lề được lắp đặt giữa các cạnh của mặt lưới giúp cho việc gấp gọn và mang chuồng đến mọi nơi.</p><br>
        <p>Thiết kế đẹp mắt, màu sắc tươi mới</p><br>
      </div>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="cart-items">
              <div class="cart-row" style="display: flex; flex-wrap: nowrap;">
                <div class="cart-item cart-column" style="width: 30%;">
                  <img class="cart-item-image" src="./img/phukien/chuong-gap-1.jpg" width="100" height="100">
                  <span class="cart-item-title">Chuồng sắt cho chó mèo (size vừa)</span>
                </div>
                <span class="cart-price cart-column" style="width: 20%; text-align: center; margin: 20px auto;">815000đ</span>
            ...
            <div class="cart-total" style="margin-top: 5px;">
              ...
              <span class="cart-total-price">815000VNĐ</span>
            </div>
