  ...
  <main>
    <div class="trangchu">
      <ul>
        ...
        <li>Balo vải mềm mịn cho thú cưng</a></li>
        <li class="BD1"></li>
      </ul>
    </div>
    <div class="dong1">
      <p>Balo vải mềm mịn cho thú cưng</p>
    </div>
    <div class="cat1">
      <div class="image-cat1">
        <img style="margin-left:70px" width="450" height="350" src="./img/phukien/tui3.jpg" alt="Túi xách chó mèo hình dấu chân">
      </div>
      <div class="sale">
        <ul>
          <li class="normal">270.000đ</li>
        </ul>
      </div>
      <div class="word1">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="cart-items">
              <div class="cart-row" style="display: flex; flex-wrap: nowrap;">
                <div class="cart-item cart-column" style="width: 30%;">
                  <img class="cart-item-image" src="./img/phukien/tui3.jpg" width="100" height="100">
                  <span class="cart-item-title">Balo vải mềm mịn cho thú cưng</span>
                </div>
                <span class="cart-price cart-column" style="width: 20%; text-align: center; margin: 20px auto;">270000đ</span>
            ...
            <div class="cart-total" style="margin-top: 5px;">
              ...
              <span class="cart-total-price">270000VNĐ</span>
            </div>
