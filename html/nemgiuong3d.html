  ...
  <main>
    <div class="trangchu">
      <ul>
        ...
        <li><a href="./balo&tuisach.html">
        <li>Chuồng & Nệm /</a></li>

        <li><a href="./balo_vaimem.html">
        <li>Nệm giường 3D cho chó mèo</a></li>
        <li class="BD1"></li>
      </ul>
    </div>
    <div class="dong1">
      <p>Nệm giường 3D cho chó mèo</p>
    </div>
    <div class="cat1">
      <div class="image-cat1">
        <img style="margin-left:70px" width="450" height="350" src="./img/phukien/nem.jpg" alt="Nệm giường 3D cho chó mèo">
      </div>
      <div class="sale">
        <ul>
          <li class="normal">350.000đ</li>
        </ul>
      </div>
      <div class="word1">
        <p>Bạn có biết, giấc ngủ không chỉ quan trọng với con người mà còn đối với tất cả các loài thú cưng nữa đấy. 
            Một giấc ngủ ngon, thoải mái sẽ giúp các thú cưng khỏe mạnh hơn, vui vẻ hơn và hơn hết, tránh được các bệnh vặt. 
            Việc để chó mèo nằm trên sàn gạch hoặc nền đất về đêm sẽ không tránh khỏi những nguy hiểm như:</p><br>
        <p>Cảm lạnh, sổ mũi, ho khan</p><br>
        <p>Bị côn trùng cắn</p><br>
        <p>=> Chắc chắn đây là điều mà những người nuôi chó mèo sẽ không bao giờ mong muốn. 
            Vì thế, ổ nằm cho chó mèo sẽ là lựa chọn sáng suốt dành cho các Boss nhà mình, 
            và tạo được thói quen đi ngủ tốt cho chó mèo.</p><br>
      </div>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="cart-items">
              <div class="cart-row" style="display: flex; flex-wrap: nowrap;">
                <div class="cart-item cart-column" style="width: 30%;">
                  <img class="cart-item-image" src="./img/phukien/nem.jpg" width="100" height="100">
                  <span class="cart-item-title">Nệm giường 3D cho chó mèo</span>
                </div>
                <span class="cart-price cart-column" style="width: 20%; text-align: center; margin: 20px auto;">350000đ</span>
            ...
            <div class="cart-total" style="margin-top: 5px;">
              ...
              <span class="cart-total-price">350000VNĐ</span>
            </div>
