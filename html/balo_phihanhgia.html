  ...
  <main>
    <div class="trangchu">
      <ul>
        ...
        <li><a href="./balo_phihanhgia.html">
        <li>Balo phi hành gia</a></li>
        <li class="BD1"></li>
      </ul>
    </div>
    <div class="dong1">
      <p>Balo phi hành gia</p>
    </div>
    <div class="cat1">
      <div class="image-cat1">
        <img style="margin-left:70px" width="450" height="350" src="./img/phukien/tui1.jfif" alt="Balo phi hành gia">
      </div>
      <div class="sale">
        <ul>
      ...
      <div class="word1">
        ...
        <p>Mặt trước của ba lô được làm bằng nhựa trong </p><br>
            ...
            <div class="cart-items">
              <div class="cart-row" style="display: flex; flex-wrap: nowrap;">
                <div class="cart-item cart-column" style="width: 30%;">
                  <img class="cart-item-image" src="./img/phukien/tui1.jfif" width="100" height="100">
                  <span class="cart-item-title">Balo phi hanh gia</span>
                </div>
