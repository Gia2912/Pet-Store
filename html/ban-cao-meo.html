  ...
  <main>
    ...
    <div class="cat1">
      <div class="image-cat1">
        <img style="margin-left:70px" width="450" height="350" src="./img/phukien/ban-cao-cho-meo.jpg" alt="Bàn Cào Mèo">
      </div>
      <div class="sale">
        <ul>
          <li class="normal">70.000đ</li>
        </ul>
      </div>
      <div class="word1">
        <p>Đồ Chơi Cho Chó Mèo Dạng Bàn Cào với màu sắc đa dạng, ngẫu nhiên.</p><br>
        <p>Sản phẩm được làm bởi chất liệu thừng cotton chất lượng cao, dệt đan chắc chắn, bền bỉ.</p><br>
        <p>Sản phẩm này là lựa chọn tuyệt vời kích thích bản năng cào của chó mèo.</p><br>
        <p></p><br>
        <p></p><br>
        <p></p><br>
        <p></p><br>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="cart-items">
              <div class="cart-row" style="display: flex; flex-wrap: nowrap;">
                <div class="cart-item cart-column" style="width: 30%;">
                  <img class="cart-item-image" src="./img/phukien/ban-cao-cho-meo.jpg" width="100" height="100">
                  <span class="cart-item-title">Bàn Cào Mèo</span>
                </div>
                <span class="cart-price cart-column" style="width: 20%; text-align: center; margin: 20px auto;">70000đ</span>
            ...
            <div class="cart-total" style="margin-top: 5px;">
              ...
              <span class="cart-total-price">70000VNĐ</span>
            </div>
